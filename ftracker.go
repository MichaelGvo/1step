...
func RunningSpentCalories(action int, weight, duration float64) float64 {
	...
	caloriesBurnedWhileRunning := ((runningCaloriesMeanSpeedMultiplier * meanSpeed * runningCaloriesMeanSpeedShift) * weight / mInKm * duration * minInH)
	return caloriesBurnedWhileRunning
}
...
func WalkingSpentCalories(action int, duration, weight, height float64) float64 {
	meanSpeed := meanSpeed(action, duration)
	meanSpeedInSquareInkmhInMsec := math.Pow(meanSpeed*kmhInMsec, 2)
	heightInMetres := height / cmInM
	...
	caloriesBurnedWhileWalking := (walkingCaloriesWeightMultiplier*weight + (meanSpeedInSquareInkmhInMsec/heightInMetres)*walkingSpeedHeightMultiplier*weight) * duration * minInH
	return caloriesBurnedWhileWalking
}
...
func SwimmingSpentCalories(lengthPool, countPool int, duration, weight float64) float64 {
	...
	caloriesBurnedWhileSwimming := (swimmingMeanSpeed + swimmingCaloriesMeanSpeedShift) * swimmingCaloriesWeightMultiplier * weight * duration
	return caloriesBurnedWhileSwimming
}
